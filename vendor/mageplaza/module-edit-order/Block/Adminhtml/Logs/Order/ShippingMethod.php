...
class ShippingMethod extends View
{
    ...
    public function getOldShippingMethodData()
    {
        ...
        if (isset($oldData['order']['shipping_method'])) {
            ...
            if (isset($oldData['method_detail'][$method])) {
                return $oldData['method_detail'][$method];
            } elseif ($method === 'freeshipping_freeshipping') {
                $methodData = [
                    'ship_amount' => '0.00',
                    'ship_tax_percent' => '0.00',
                    'ship_discount_amount' => '0.00',
                    'total_fee' => '0.00',
                    'ship_description' => 'Free Shipping'
                ];
                return $methodData;
            }
        }
     ...
     * @return array
     */
    public function getNewShippingMethodData()
    {
        ...
        if (isset($newData['order']['shipping_method'])) {
            ...
            if (isset($oldData['method_detail'][$method])) {
                return $newData['method_detail'][$method];
            } elseif ($method === 'freeshipping_freeshipping') {
                $methodData = [
                    'ship_amount' => '0.00',
                    'ship_tax_percent' => '0.00',
