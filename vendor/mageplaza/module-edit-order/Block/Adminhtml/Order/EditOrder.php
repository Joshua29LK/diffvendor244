...
class EditOrder extends Form
{
    ...
    public function getCustomerData()
    {
        ...
        if (!$order->getCustomerId()) {
            $dataCustomer = $dataOrder;
        } else {
            $dataCustomer = $this->getCustomerInformationData($order->getCustomerId());
        }
        $data = ['currentCustomer' => $dataOrder,
     ...
     * @throws NoSuchEntityException
     */
    public function getCustomerInformationData(int $customerId)
    {
        $data = [];
        ...
        if ($customer) {
            $data = [
                ...
                'midName' => $customer->getMiddlename(),
    ...
    public function getCustomerUrls()
    {
        ...
        foreach ($customerCollection->getItems() as $item) {
            ...
            $urlAr[$customerId] = $this->getUrl('customer/index/edit', ['id' => $customerId]);
        }

        return HelperData::jsonEncode($urlAr);
    }
     ...
     * @return bool
     */
    public function getInvoiceColection()
    {
        $order        = $this->getCurrentOrder();
        $isHaveInvoice = false;
