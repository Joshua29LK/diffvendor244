...
class CustomerInfo extends Generic
{
    ...
    protected function _prepareForm()
    {
        ...
        $emailClass = 'validate-email'.$this->isIssetCustomer($order->getCustomerEmail());
        ...
        $fieldset->addField(
            ...
            [
                ...
                'value' => $customer->getData('website_id') ?: 1
            ]
        );
        ...
        if (!$this->_storeManager->hasSingleStore()) {
            $fieldset->addField(
                ...
                [
                    ...
                    'value' => $customer->getData('store_id') ?: 1
                ]
            );
        } else {
            $fieldset->addField(
     ...
     * @return string
     */
    public function isIssetCustomer($email = '')
    {
        if ($email !== '') {
            $customer     = $this->customerFactory->create();
            $customerData = $customer->getCollection()->addFieldToFilter('email', $email);
