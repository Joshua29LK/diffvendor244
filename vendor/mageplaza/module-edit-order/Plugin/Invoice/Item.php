...
class Item
{
     ...
     */
    public function aroundGetOrderItem(InvoiceItem $object, Closure $process)
    {
        if ($this->_orderItem === null) {
            if ($object->getInvoice()) {
                $this->_orderItem = $object->getInvoice()->getOrder()->getItemById($object->getOrderItemId());
            } else {
        ...
        } elseif ($object->getInvoice()) {
            $orderId = $object->getInvoice()->getOrderId();
        }
