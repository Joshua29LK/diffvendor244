...
class Item
{
    ...
    /**
     * @param CreditmemoItem $object
     * @param Closure $process
     * @return \Magento\Sales\Model\Order\Item|mixed|null
     */
    public function aroundGetOrderItem(CreditmemoItem $object, Closure $process)
    {
        if ($this->_orderItem === null) {
            if ($object->getCreditmemo()) {
                $this->_orderItem = $object->getCreditmemo()->getOrder()->getItemById($object->getOrderItemId());
            } else {
        ...
        } elseif ($object->getCreditmemo()) {
            $orderId = $object->getCreditmemo()->getOrderId();
        }
