 ...
 * @since 100.0.2
 */
class WidgetSortBought implements \Magento\Framework\Option\ArrayInterface
{
    /**
     * Options getter
     *
    ...
    public function toOptionArray()
    {
        return [
            ...
            ['value' => 5, 'label' => __('Ordered Quantity of Product (High-Low)')]
        ];
    }
    ...
    public function toArray()
    {
        return [
            ...
            5 => __('Ordered Quantity of Product (High-Low)')
        ];
    }
}
