...
class SortBought extends \Magento\Eav\Model\Entity\Attribute\Source\AbstractSource
{
    ...
    public function getAllOptions()
    {
        if (!$this->_options) {
            $this->_options = [
                ...
                ['label' => __('Ordered Quantity of Product (High-Low)'), 'value' => self::ORDER_QTY],
                ['label' => __('Frequently Bought Together'), 'value' => self::ORDER_FREQUENT],
            ];
        }
